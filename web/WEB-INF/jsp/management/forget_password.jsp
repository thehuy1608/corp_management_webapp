<%-- 
    ...
    Created on : Jun 21, 2018, 1:32:20 PM
    Author     : WIN 10
--%>
    ...
    <body>
        ...
        <div class="main_container">
            <div class="login_form_modal">
                ...
                <form action="${pageContext.servletContext.contextPath}/login/forget_password" class="login_form_wrapper" method="POST">
                    <div class="style_login_message">${requestScope.login_message}</div>
                    <div class="login_form_loginname_wrapper" style="margin-top: 30px;">
                        <label for="id_login_form_input_loginname" class="style_form_input_text_label" id="id_login_form_input_loginname_label">Email</label>
                        <input type="text" name="email" value="" class="style_form_input_text" id="id_login_form_input_loginname" onfocus="show_focus_border('id_login_form_input_loginname_focus_border'); show_focus_label('id_login_form_input_loginname_label');"
                               onfocusout="hide_focus_border('id_login_form_input_loginname_focus_border'); hide_focus_label('id_login_form_input_loginname_label', 'id_login_form_input_loginname');">
                    ...
                    <div class="login_form_submit_button_wrapper">
                        <button name="reset_password" style="text-transform: capitalize;" type="submit" class="style_primary_button">Reset Password</button>
                    </div>
                    ...
                    <div class="login_form_submit_with_face_button_wrapper">
                        <button name="back_to_login" style="text-transform: capitalize;" type="submit" class="style_success_button">Back to login</button>
                    </div>
